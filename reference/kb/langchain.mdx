...
| --- | --- | --- | --- |
| `loader` | `Callable` | - | LangChain retriever. |
| `vectorstore` | `Any` | - | LangChain vector store used to create a retriever. |
| `search_kwargs` | `dict` | - | Search kwargs when creating a retriever using the langchain vector store. |
