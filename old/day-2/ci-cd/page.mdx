---
title: CI/CD
description: Phidata templates come pre-configured with [Github Actions](https://docs.github.com/en/actions)for CI/CD. We can
---
...
<ImageContainer src="/images/validate-cicd.png" alt="validate-cicd" />
...
<ImageContainer
  src="/images/docker-access-token.png"
...
Follow this [guide](https://aws.amazon.com/blogs/security/use-iam-roles-to-connect-github-actions-to-actions-in-aws/) to create an IAM role in your AWS account which will be used by the github action.
...
<ImageContainer
  src="/images/github-oidc-provider.png"
  alt="github-oidc-provider"
/>
...
<ImageContainer src="/images/github-oidc-role.png" alt="github-oidc-role" />
