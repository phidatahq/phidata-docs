...
description: The Development Application** runs locally on docker and its resources are defined in the `workspace/dev_resources.py` file. This guide shows how to
---
