---
title: Build an AI App from scratch
sidebarTitle: Build an AI App
---

This guide walks through the basics of building an AI App, by the end you'll have a mini AI App with a knowledge base, storage and memory.
