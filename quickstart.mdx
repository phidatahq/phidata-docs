...
- **Monitor, evaluate and optimize your agents and application.** Phidata will monitor your sessions and metrics to help you understand and improve your agentic system.
...
Let's create an agent that can search its knowledge base and answer questions. Instead of always inserting the "context" into the prompt, this agent searches the vector database for what it needs, when it needs. This saves tokens and improves response quality.
...
Structured outputs allow you to enforce the structure of the output from an agent. The agent will return a pydantic object.
...
You can either start by building your own agents or use one of our templates to build a full-stack agentic system.
