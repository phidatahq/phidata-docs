...
Let's build an AI App powered by GPT-4. We'll use PgVector for knowledge and storage and serve the app using Streamlit and FastApi.
...
**By the end of this guide you'll have your own RAG LLM App.**
