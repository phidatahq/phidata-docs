...
The following conversation will write a python function to get top hackernews stories, run it and summarize the results.
...
For more control, write your own functions and provide them as tools to a conversation. Creating your own tools i as simple as writing a python function (which you can use the PythonTools to generate). For example:
