...
The `Conversation` class provides a user-friendly interface to language models, meaning behind the scenes it converts the message into `system` and `user` prompts.
