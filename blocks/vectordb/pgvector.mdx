...
A Knowledge Base is a database of information that the LLM can search to improve its responses. Knowledge Bases play a critical part in making LLMs respond in a context-aware manner.
...
- [PDF knowledge base](/blocks/kb/pdf)
...
## PDFKnowledgeBase
    ...
    <Note>Install `pypdf` using [this guide](/how-to/python-libraries)</Note>
...
## TextKnowledgeBase
    ...
    <Note>Install `textract` using [this guide](/how-to/python-libraries)</Note>
...
## WebsiteKnowledgeBase
    ...
    <Note>Install `beautifulsoup4` using [this guide](/how-to/python-libraries)</Note>
...
## WikipediaKnowledgeBase
    ...
    <Note>Install `wikipedia` using [this guide](/how-to/python-libraries)</Note>
...
## ArxivKnowledgeBase
    ...
    <Note>Install `arxiv` using [this guide](/how-to/python-libraries)</Note>
