...
The following assistant will write a python script that creates the fibonacci series, saves it to a file, runs it and returns the result.

```python cookbook/tools/python.py
