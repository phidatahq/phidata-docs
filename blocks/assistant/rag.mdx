...
To enable **RAG**, add a Knowledge Base to the `Assistant` and set `add_references_to_prompt=True`. This will search the **Knowledge Base** for information about the `message` and add it to the prompt before sending it to the LLM.
