...
Assistants are a user-friendly interface to language models that enables them to solve tasks by intelligently choosing a course of action using [function calling](https://platform.openai.com/docs/guides/function-calling).

They come with **memory**, **knowledge**, **storage** and **tools** built-in, making it easy to build RAG, Autonomous or Multimodal applications. A simple assistant looks like:
