...
**Assistants** enable LLMs to solve tasks by intelligently choosing a course of action using [function calling](https://platform.openai.com/docs/guides/function-calling). They come with built-in **memory**, **knowledge**, **storage** and **tools** built-in, making it easy to build RAG, Autonomous or Multimodal applications.
