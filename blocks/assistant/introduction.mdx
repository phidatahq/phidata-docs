...
**Assistants** use LLMs to solve problems by [calling functions](https://platform.openai.com/docs/guides/function-calling). They have their own memory, knowledge base and storage, making them ideal for building AI products.
...
- [Assistant Instructions/Prompts](/blocks/assistant/instructions)
