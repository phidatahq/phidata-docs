...
The `Assistant` class provides a user-friendly interface to language models, but behind the scenes it converts the description, instruction and message into `system` and `user` prompts.
