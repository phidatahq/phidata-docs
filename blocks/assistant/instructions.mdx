...
The `Assistant` class provides a user-friendly interface to language models, but behind the scenes it converts the description, instruction and messages into `system` and `user` prompts.

<Warning>

This guide need to be updated for the description and instructions parameter.

</Warning>

## Usage

### Update prompts for a RAG Assistant
...
### Update prompts for an Autonomous Assistant
...
<ResponseField name="system_prompt" type="str" default="None">
  If provided, sets the `System Prompt` sent to the ai.
</ResponseField>
<ResponseField name="system_prompt_function" type="Callable[..., Optional[str]]" default="None">
  A function which returns the `System Prompt` sent to the ai.
...
<ResponseField name="use_default_system_prompt" type="str" default="True">
  If True, the Assistant provides a default system prompt
</ResponseField>
<ResponseField name="user_prompt" type="str" default="None">
  If provided, sets the `User Prompt` sent to the ai.
</ResponseField>
<ResponseField name="user_prompt_function" type="Callable[..., str]" default="None">
  A function which returns the `User Prompt` sent to the ai.
