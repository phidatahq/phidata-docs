...
OpenAI provides a powerful [Assistants API](https://platform.openai.com/docs/assistants/overview) and phidata provides an easy to use interface for building applications with them. Assistants can leverage models, run code in a sandboxed environment and retrieve information from a knowledge base.
