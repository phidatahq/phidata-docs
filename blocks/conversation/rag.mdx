...
<ResponseField name="storage" type="ConversationStorage">
  Save conversations to a database. [Read more](/blocks/storage/introduction)
</ResponseField>
<ResponseField name="knowledge_base" type="KnowledgeBase">
  Convert PDFs into vector embeddings and store them in a vector db. [Read
  more](/blocks/kb/introduction)
</ResponseField>
