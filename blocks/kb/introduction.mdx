...
A Knowledge Base is a database of information that the LLM can search to improve its responses. Knowledge Bases make LLMs respond in a context-aware manner by enabling Retrieval Augmented Generation (**RAG**).
