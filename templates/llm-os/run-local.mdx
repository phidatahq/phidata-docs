...
```bash
ai-app                      # root directory of your llm-os
├── ai
...
If you'd like to use the research assistant, export your `EXA_API_KEY`. You can get one [from here](https://dashboard.exa.ai/api-keys) if needed.
