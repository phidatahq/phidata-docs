...
The `api-app` provides sample endpoints you can use to build your own AI product. These routes are developed in collaboration with real AI Apps and are a great starting point to build on.
