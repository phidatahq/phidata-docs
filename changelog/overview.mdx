---
title: "Playground and SDK updates"
mode: "wide"
---
...
- **Playground Reference Component**: Added a reference component in the Playground so the user sees the source of the information.
