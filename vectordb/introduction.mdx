...
- [PgVector](/vectordb/pgvector) (with hybrid search capability)
- [LanceDb](/vectordb/lancedb)   (with hybrid search capability)
- [Pinecone](/vectordb/pinecone) (with hybrid search capability)
