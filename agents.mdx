---
title: Agents
description: Agents are intelligent programs that can interact with external systems.
---

For example, an agent can search the web, write and run code, analyze financial data, query a database or interact with any application using an API.
...
- **Build agentic systems i.e. software applications with an API, database and vectordb.**
