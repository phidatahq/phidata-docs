---
title: Agents
description: Agents are intelligent programs that achieve tasks by taking actions.
---
...
- **Build intelligent Agents with memory, knowledge, tools and reasoning.** Phidata will manage the agent's state, memory and knowledge in a database.
...
- **Run your Agents as a software application (with a database, vectordb and api).** Phidata will manage your infrastructure, both local and cloud (BYOC).
