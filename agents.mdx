---
title: Agents
description: "**Agents are autonomous programs powered by language models.**"
---

Agents can interact with external systems (such as searching the web, executing code, and making API calls), process complex information, learn from their actions, and progressively work towards solving specific tasks.

## What is phidata?

**Phidata is a framework for building agentic software**, use phidata to:
...
- **Build agentic software i.e. applications with an API, database and vectordb.**
