...
Phidata agents support text, images, audio, video and more. For example, you can create an image agent that can understand images and make tool calls as needed
