---
title: Agents
description: "**Agents are autonomous programs that solve problems using language models.**"
---

Agents solve problems by:
1. Planning a course of action
2. Interacting with external systems (like searching the web and making API calls)
3. Processing the information received
4. Learning from their actions
5. Progressively working towards an outcome
