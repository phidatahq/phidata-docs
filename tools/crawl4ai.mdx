...
**Crawl4aiTools** enable an Agent to perform web crawling and scraping tasks using the Crawl4ai library.View it here: [Github](https://github.com/unclecode/crawl4ai).
