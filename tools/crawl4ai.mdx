...
The following agent will scrape the content from the https://github.com/AgnoAgi/phidata webpage:
...
agent.print_response("Tell me about https://github.com/AgnoAgi/phidata.")
```
...
- View on [Github](https://github.com/AgnoAgi/phidata/blob/main/phi/tools/crawl4ai_tools.py)
