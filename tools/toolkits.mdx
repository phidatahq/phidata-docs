...
A **Toolkit** is a collection of functions that can be added to an Agent. The functions in a Toolkit work together to provide a better development experience.
