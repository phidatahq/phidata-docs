...
Tools are **functions** that an Agent can run to achieve tasks like searching the web, running SQL, sending an email or calling APIs. Tools integrate Agents with external systems.
