...
Tools are **functions** that an Agent can run to achieve tasks like searching the web, running SQL, sending an email and calling APIs. **Tools make LLMs autonomous**.
