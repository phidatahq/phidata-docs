...
Phidata provides a beautiful Agent UI for interacting with your agents. This is what it looks like:
...
You can authenticate with phidata by running the following command:
