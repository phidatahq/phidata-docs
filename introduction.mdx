...
**Phidata is a toolkit for building AI applications using function calling.** It provides pre-built templates for AI apps that you can clone & run in minutes. Here's how it works:
