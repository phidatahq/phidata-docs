...
Phidata is an [open source](https://github.com/phidatahq/phidata) toolkit for building AI products.

It gives you production-ready AI Apps with 1 command. It's designed to provide a paved-path for building AI products to anyone with basic python skills.
