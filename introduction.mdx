...
**Phidata is a toolkit for building AI applications using Autonomous Assistants.** It provides pre-built templates for AI Apps that you can run in minutes. Here's how it works:

- Create your codebase using a template: `phi ws create`
- Run your AI App locally: `phi ws up dev:docker`
- Integrate with your product/front-end
- Deploy your AI App to AWS: `phi ws up prd:aws`
- Customize, monitor and improve

## Under the hood

Phidata provides user-friendly **Assistants** that can achieve any task by intelligently choosing a course of action using function calling. For example, to answer questions from a document, the assistant calls a function to search the document, synthesize the results and return the answer.

<img src="/images/assistants-explanation.png" alt="How assistants work" />
