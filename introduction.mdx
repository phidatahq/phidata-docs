...
Phidata provides user-friendly **Assistants** that can achieve any task by intelligently choosing a course of action by calling functions. For example, to answer questions from a document, the assistant calls a function to search the document, synthesize the results and return the answer.
