...
It provides a simple **Assistant** interface that enables LLMs to intelligently choose their course of action to solve tasks. Assistants come with **memory**, **knowledge**, **storage** and **tools**, making it easy to build AI applications.
