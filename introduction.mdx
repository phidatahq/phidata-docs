...
Phidata is an [open source](https://github.com/phidatahq/phidata) toolkit for building AI products. It provides a paved-path for building AI products using pre-built AI Apps that you can run locally using docker or deploy to AWS.
