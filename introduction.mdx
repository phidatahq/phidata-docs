...
Assistants enable LLMs to achieve tasks by intelligently choosing a course of action using [function calling](https://platform.openai.com/docs/guides/function-calling). They come with built-in **memory**, **knowledge**, **storage** and **tools**, providing a human-like interface to language models.

Assistants can be used to build any kind of AI product. For example:
