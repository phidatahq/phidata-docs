...
**Phidata is a toolkit for building applications using LLMs.** It provides pre-built AI Apps that you can integrate with your product in minutes. Here's how it works:
