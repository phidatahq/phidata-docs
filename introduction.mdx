...
**Phidata is a toolkit for building applications using AI Assistants.** It provides pre-built templates for AI apps that you can use to get started quickly. Here's how it works:
