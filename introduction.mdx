...
Phidata is an open-source toolkit for building AI products. It gives you production-ready AI Apps that can run locally using docker or be deployed to AWS with 1 command.
