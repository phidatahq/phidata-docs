**Here's how vector databases are used as a knowledge base for AI products:**

<Steps>
  <Step title="Goal: Search relevant information from a knowledge base quickly">
    Our goal is to search our knowledge base for information related to our input query which can be provided to the LLM as context.
  </Step>
  <Step title="Chunk the information">
    We break down the data in our knowledge base into small chunks to ensure our search query returns the most relevant results.
  </Step>
