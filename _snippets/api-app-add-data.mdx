...
The `pdf_knowledge_base` in the `llm/knowledge_base.py` file provides the references (context) used by the sample endpoints. To add your data:
...
<Step title="Update Knowledge Base">
  Update the knowledge base using `/v1/pdf/conversation/load-knowledge-base`
</Step>
</Steps>
