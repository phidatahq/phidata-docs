...
This streamlit app is defined in the `app/pages/2_Chat_with_Images.py` file and the `Assistants` powering these apps are defined in the `ai/assistants` folder.

Checkout the `ai/assistants/vision.py` file for more information.
...
- [Run your AI App on AWS](/examples/ai/multimodal/run-aws)
