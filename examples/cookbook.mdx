...
The [phidata cookbook](https://github.com/phidatahq/phidata/tree/main/cookbook) contains in-depth examples code, from basic assistants, function calling, structured output to advanced fine-tuning and evaluations.
