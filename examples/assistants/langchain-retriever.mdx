...
```python cookbook/assistants/langchain_retriever.py
...
- View on [Github](https://github.com/phidatahq/phidata/blob/main/cookbook/assistants/langchain_retriever.py)
