...
The Recipe Agent generates personalized recipe recommendations based on user inputs like ingredients, time, and dietary preferences. It relies on two recipe PDFs stored in a PgVector-powered knowledge database for fast and efficient searches, then enhances suggestions with web searches using ExaTools.
