...
The Shopping Partner Agent is a personalized product recommendation assistant that helps users find items matching their preferences and needs. It uses FirecrawlTools to search trusted e-commerce platforms, ensuring recommendations are accurate, in stock, and sourced from reliable websites.
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        pip install phidata google-generativeai openai firecrawl-py packaging
        ```
    </Step>
