...
Here you'll find examples that'll help you use phidata, from basic **agents and workflows** to advanced **fine-tuning and evaluations**. If you have more, please [contribute](https://github.com/AgnoAgi/phidata-docs) to this list.

You can run each recipe individually or clone the [phidata cookbook](https://github.com/AgnoAgi/phidata/tree/main/cookbook) and run it from there.
