...
<CardGroup cols={3}>
  ...
  <Card title="Recipe Genie" icon="brain" iconType="duotone" href="/examples/agents/ai-recipe-creator">
    An Agent that can suggest recipes based upon user's input.
  </Card>
  ...
  <Card title="RecipeGenie" icon="brain" iconType="duotone" href="/examples/agents/ai-recipe-creator">
    An Agent that can suggest recipes based upon user's input.
  </Card>
</CardGroup>
