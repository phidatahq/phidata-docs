...
<CardGroup cols={3}>
  ...
  <Card title="Popcorn Pal" icon="eye" iconType="duotone" href="/examples/agents/movie-recommendation-agent">
    An Agent that can recommend movies.
  </Card>
  <Card title="Globe Hopper" icon="globe" iconType="duotone" href="/examples/agents/itinerary-planner-agent">
    An Agent that can plan your itinerary.
  </Card>
</CardGroup>
