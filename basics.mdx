...
To provide LLMs with business context, we store information in a vector database that the Assistant can search to improve its responses. By adding this extra context to the prompt, LLMs are able to respond in a context-aware manner.
