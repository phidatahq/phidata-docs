...
**Assistants** enable LLMs to solve tasks by intelligently choosing a course of action. They come with built-in **Memory**, **Knowledge**, **Storage** and **Tools**, making it easy to build AI products.
