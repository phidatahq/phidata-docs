...
Let's learn the basics by building an AI Assistants with knowledge base, storage and tools.

## Assistants

With phidata, we build AI applications using **Assistants**.

**Assistants** use LLMs to achieve tasks by calling functions. They have their own memory, knowledge base and storage, making it easy to build intelligent AI applications.
...
Lets create an Assistant that can call a function to summarize top HackerNews stories.

<Steps>
  <Step title="Create HackerNews Assistant">
    Create a file `hn_assistant.py`
