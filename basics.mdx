...
**Assistants** use LLMs to solve problems by calling functions. They have their own memory, knowledge base and storage, making them ideal for building AI products.
