...
You can also find more information about langchain here [LangChain Chroma Vector Store Documentation](https://python.langchain.com/docs/integrations/vectorstores/chroma/)
