...
Resources are the infrastructure components for your application. Similar to [Apps](/blocks/app/introduction), we define them as python classes and create using `phi start` or `phi ws up`.
...
- [Docker Resources](/blocks/resource/docker)
- [AWS Resources](/blocks/resource/aws)
- [Kubernetes Resources](/blocks/resource/k8s)
